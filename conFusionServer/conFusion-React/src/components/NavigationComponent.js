                    ...
                    <div className="container d-flex flex-row justify-content-around w-100">
                        <Nav navbar>
                            <NavItem className="textMenu">
                                <NavLink className="nav-link" to="/howtouse" activeStyle={{color:'white',fontWeight:'bold'}}>
                        ...
                        <Nav navbar>
                            <NavItem className="textMenu">
                                <NavLink className="nav-link" to="/contactus" activeStyle={{color:'white',fontWeight:'bold'}}>
                                    <div className="row d-flex flex-column justify-content-center align-items-center">
